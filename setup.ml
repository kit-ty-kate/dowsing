...
(* OASIS_START *)
(* DO NOT EDIT (digest: ea49e8e0b4dac6066334e4ace2a05288) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = ["ocamlbuild_more_args"; "pure_interface"];
          beta_features = [];
          name = "Dowsing";
          license_file = None;
          copyrights = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Hullot_bin_tree"; "Bit_field"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "dowsing";
                           FindlibPackage ("ocp-index.lib", None);
                   ...
                   {exec_custom = false; exec_main_is = "dowsindex.ml"});
               Doc
                 ({
                     cs_name = "dowsing";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Dowsing";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Drup/dowsing.git";
                      src_repo_browser =
                        Some "https://github.com/Drup/dowsing";
     ...
     oasis_digest = Some "\150\005\208G\138he,\b\212QA[\208=x";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
